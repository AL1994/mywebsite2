...
* { padding: 0; margin: 0; }
li { list-style: none; }
body { background: url(assets/admin/files/img/bgg.gif); }
...
<h2 id="title1">图片滑动展示效果</h2>
<h3 id="title2"><a href="#">JavaScript, CSS</a></h3>
...
<div id="images_slide">
	...
	<img src="assets/admin/files/img/abs/1.jpg" style="z-index:1;" />
	<img src="assets/admin/files/img/abs/2.jpg" style="z-index:2;" />
	<img src="assets/admin/files/img/abs/3.jpg" style="z-index:3;" />
...
window.onload=function ()
{
	...
	var aEffect=null;
	(aEffect=[
		(function (obj){for(var f=1;f<=2;f++)css(document.getElementById('title'+f), 'display', 'block');})(),
	...
	if(arguments.length==2)
		...
		switch(attr)
		{
			...
			case 'opacity':
				...
				break;
			default:
					//console.log(obj.style[attr]=value);
