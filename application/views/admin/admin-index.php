...
<?php include 'admin-sidebar.php';?>
  ...
  <div class="admin-content">
    ...
    <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
      ...
      <li><a href="#" class="am-text-warning"><span class="am-icon-btn am-icon-briefcase"></span><br/>新增留言<br/>308</a></li>
      
      <li><a href="#" class="am-text-danger"><span class="am-icon-btn am-icon-recycle"></span><br/>新增评论<br/>80082</a></li>
    ...
    <!-- <div class="am-g">
      <div class="am-u-sm-12">
        <table class="am-table am-table-bd am-table-striped admin-content-table">
          <thead>
          <tr>
            <th>ID</th><th>用户名</th><th>留言内容</th><th>留言时间</th><th>管理</th>
          </tr>
          </thead>
          <tbody>
          	<?php 
          	...
          	?>
          		<tr>
	          	<td><?php echo $v->message_id;?></td><td><?php echo $v->messager_name;?></td><td><a href="#"><?php echo $v->content;?></a></td> <td><span class="am-badge am-badge-success"><?php echo $v->add_time;?></span></td>
	            <td>
